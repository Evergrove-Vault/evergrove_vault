...
Использует [[NER]] для поиска сущностей в тексте. Далее берется контекст вокруг данной сущности, связанный по смыслу. Это можно сделать с помощью [[semantic text segmentation]]
